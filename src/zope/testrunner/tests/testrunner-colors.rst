...
Tests which are skipped are colorized::
    ...
    {normal}  Running:{normal}
     sample_skipped_tests.TestSkipppedNoLayer.test_skipped ({boldyellow}skipped: I'm a skipped test!{normal})
...
At very high verbosity levels you can see the time taken by each test
    ...
    {normal}Running zope.testrunner.layer.UnitTests tests:{normal}
      Set up zope.testrunner.layer.UnitTests in {green}N.NNN{normal} seconds.
    {normal}  Running:{normal}
     sample1.sampletests.test_one.TestNotMuch.test_1 ({green}N.NNN s{normal})
     sample1.sampletests.test_one.TestNotMuch.test_2 ({green}N.NNN s{normal})
     sample1.sampletests.test_one.TestNotMuch.test_3 ({green}N.NNN s{normal})
     sampletests.test_one.TestNotMuch.test_1 ({green}N.NNN s{normal})
     sampletests.test_one.TestNotMuch.test_2 ({green}N.NNN s{normal})
     sampletests.test_one.TestNotMuch.test_3 ({green}N.NNN s{normal})
...
make all of the tests seem slow.
    ...
    {normal}Running zope.testrunner.layer.UnitTests tests:{normal}
      Set up zope.testrunner.layer.UnitTests in {green}N.NNN{normal} seconds.
    {normal}  Running:{normal}
     sample1.sampletests.test_one.TestNotMuch.test_1 ({boldmagenta}N.NNN s{normal})
     sample1.sampletests.test_one.TestNotMuch.test_2 ({boldmagenta}N.NNN s{normal})
     sample1.sampletests.test_one.TestNotMuch.test_3 ({boldmagenta}N.NNN s{normal})
     sampletests.test_one.TestNotMuch.test_1 ({boldmagenta}N.NNN s{normal})
     sampletests.test_one.TestNotMuch.test_2 ({boldmagenta}N.NNN s{normal})
     sampletests.test_one.TestNotMuch.test_3 ({boldmagenta}N.NNN s{normal})
    {normal}  Ran {green}6{normal} tests with {green}0{normal} failures, {green}0{normal} errors, {green}0{normal} skipped in {green}N.NNN{normal} seconds.{normal}
    {normal}Tearing down left over layers:{normal}
      Tear down zope.testrunner.layer.UnitTests in {green}N.NNN{normal} seconds.
    False
